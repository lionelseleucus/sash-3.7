...
void
do_jsonast(int argc __attribute__((unused)), const char ** argv __attribute__((unused))){
	printf("%s\n", "Lancement de la commande jsonast\n");
}
...
void
do_cd(int argc __attribute__((unused)), const char ** argv __attribute__((unused)))
{
	const char *	path;
